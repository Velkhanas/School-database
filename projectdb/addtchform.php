...
<div class="row">
    <div class="col-sm-6">
<div class="h5 text-center alert alert-primary mb-3 mt-3" role="alert"> เพิ่มอาจารย์ </div>
    <form method="POST" action="addtch.php">
        <label>ชื่อ-นามสกุล:</label>
        <input type="text" name="Teacher_name" class="form-control" type="text" placeholder="ไม่ต้องมีคำนำหน้าชื่อ" aria-label="name" required><br>
